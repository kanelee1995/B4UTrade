...
// Data fetching for stock details page
  useEffect(() => {
    const options = {
      method: "GET",
    ...
    axios
      ...
      .then(function (response) {
        ...
        setstockDateData(response.data["values"].map(stock => stock["datetime"]));
        setstockCloseData(response.data["values"].map(stock => stock["close"]));
      })
      ...
      <div className="app">
        ...
        <Switch>
          ...
          <Route exact path="/stockdetail">
            <StockDetail stockDate={stockDateData} stockClose={stockCloseData} tableData={tableData}/>
          </Route>
        </Switch>
